...
const userName = UserInfo.getUserData().name;
const userAvatar = UserInfo.getUserData().avatarURL;
...
export default class GlobalHeaderRight extends PureComponent {
  ...
  UNSAFE_componentWillMount() {
    // const name = UserInfo.getUserData().name;
    // const url =  UserInfo.getUserData().avatarURL;
    // const em = UserInfo.getUserData().email;
    this.updateData(UserInfo.getUserData());
  }

  componentDidMount() {
  }

  updateData({name, email, avatarURL, publicCryptoAddress})
  {
    // console.log(`Name: ${name} , email: ${email} , avatar: ${avatarURL}`);
    this.setState({userName: name, userAvatar: avatarURL, useremail: email});
  }
